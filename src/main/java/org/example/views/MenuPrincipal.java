...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		imagenFondo.setIcon(new ImageIcon("src/main/java/org/example/imgs/menu-img.png"));
		panel.add(imagenFondo);
		
		JLabel logo = new JLabel("");
		logo.setBounds(722, 80, 150, 156);
		logo.setIcon(new ImageIcon("src/main/java/org/example/imgs/aH-150px.png"));
		panel.add(logo);
		...
		imagenLogin.setIcon(new ImageIcon("src/main/java/org/example/imgs/login.png"));
