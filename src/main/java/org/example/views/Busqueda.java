...
public class Busqueda extends JFrame {
	...
	public JTable tbHuespedes;
	public JTable tbReservas;
	...
	public JTabbedPane panel = new JTabbedPane(JTabbedPane.TOP);
	int xMouse, yMouse;
	 ...
	 */
	public Busqueda() {
		controller=new BusquedaController(this);
		...
		panel.addTab("Reservas", new ImageIcon("src/main/java/org/example/imgs/reservado.png"), scroll_table, null);
