...
import org.example.controllers.RegistroHuespedController;
...
public class RegistroHuesped extends JFrame {
	...
	public JComboBox<Format> txtNacionalidad;
	public JLabel labelAtras,labelExit;
	int xMouse, yMouse;
	public JPanel btnAtras=new JPanel();
	public JPanel btnexit=new JPanel();
	public JPanel btnguardar=new JPanel();
	...
	public RegistroHuesped(long idreserva) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage("/src/main/java/org/example/imgs/lOGO-50PX.png"));
		...
		imagenFondo.setIcon(new ImageIcon("src/main/java/org/example/imgs/registro.png"));
		...
		RegistroHuespedController controller = new RegistroHuespedController(this);
	}
