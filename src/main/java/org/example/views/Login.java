...
public class Login extends JFrame {
    ...
    public Login() {
        ...
        imgHotel.setIcon(new ImageIcon("src/main/java/org/example/imgs/img-hotel-login-.png"));
        ...
        lblNewLabel_1.setIcon(new ImageIcon("src/main/java/org/example/imgs/lOGO-50PX.png"));
